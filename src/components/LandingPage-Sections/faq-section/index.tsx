import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@/components/ui/LandingPage/accordion";
      ...
      <div className="w-[80%] mx-auto border border-white/[0.2] p-3 rounded-md">
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>
              Can I integrate my own materials into the generated courses?
            </AccordionTrigger>
            <AccordionContent className="text-[#8678F9] font-bold">
              Absolutely! Users can easily add their own documents, videos, and
              other materials to the AI-generated framework.
            </AccordionContent>
          </AccordionItem>
